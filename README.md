...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:10.4.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:10.4.0 --help
```
...
- [@semantic-release/release-notes-generator: 14.0.2](https://www.npmjs.com/package/@semantic-release/release-notes-generator/v/14.0.2)
