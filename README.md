...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:9.3.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:9.3.0 --help
```
...
- [@semantic-release/github: 10.1.4](https://www.npmjs.com/package/@semantic-release/github/v/10.1.4)
