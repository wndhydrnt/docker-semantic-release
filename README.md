...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:1.6.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:1.6.0 --help
```
...
- [semantic-release: 21.0.9](https://www.npmjs.com/package/semantic-release/v/21.0.9)
