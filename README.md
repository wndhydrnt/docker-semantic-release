...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:7.14.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:7.14.0 --help
```
...
[Node](https://hub.docker.com/_/node): 20.14.0
...
- [@semantic-release/github: 10.0.5](https://www.npmjs.com/package/@semantic-release/github/v/10.0.5)
