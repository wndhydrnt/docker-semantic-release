...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:10.9.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:10.9.0 --help
```
...
[Node](https://hub.docker.com/_/node): 20.18.2
