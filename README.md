...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:9.7.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:9.7.0 --help
```
...
- [@semantic-release/github: 10.1.7](https://www.npmjs.com/package/@semantic-release/github/v/10.1.7)
