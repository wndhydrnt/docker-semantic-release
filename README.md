...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:1.19.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:1.19.0 --help
```
...
- [@semantic-release/github: 9.2.0](https://www.npmjs.com/package/@semantic-release/github/v/9.2.0)
