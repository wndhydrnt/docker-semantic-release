...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:1.10.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:1.10.0 --help
```
...
- [@semantic-release/release-notes-generator: 11.0.6](https://www.npmjs.com/package/@semantic-release/release-notes-generator/v/11.0.6)
