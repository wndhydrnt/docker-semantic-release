...
```shell
docker pull ghcr.io/wndhydrnt/docker-semantic-release:9.10.0
docker run --rm -it ghcr.io/wndhydrnt/docker-semantic-release:9.10.0 --help
```
...
- [@semantic-release/github: 10.3.1](https://www.npmjs.com/package/@semantic-release/github/v/10.3.1)
